"""
Pipeline de Transformação de Dados do Mercado de Ações
=====================================================

Este script processa dados brutos do Yahoo Finance e arquivos ERP,
transformando-os em um modelo dimensional para análise.
"""
...
def create_spark_session(app_name: str) -> SparkSession:
    """
    Cria uma sessão Spark otimizada com configurações adequadas.
...
def validate_arguments(args: argparse.Namespace) -> None:
    ...
    if not args.previous_day:
        raise ValueError("Data anterior é obrigatória")
